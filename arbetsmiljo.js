...
const backToHomeBtn = document.getElementById('backToHomeBtn'); // Knappen för att gå tillbaka
...
backToHomeBtn.addEventListener('click', () => {
    window.location.href = 'index.html'; // Ändra till din startsida, om det är en annan fil
});
